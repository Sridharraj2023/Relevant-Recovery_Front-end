        ...
        <Box sx={{  width: '100%', maxWidth: 600, ml: { md: 0 } , mt: { xs: 4, md: 0 } }}>
          <Box sx={{ background: '#fff', borderRadius: 3, p: 3, boxShadow: 2, }}>
            <form>
              ...
              <Button variant="text" fullWidth sx={{ background: 'linear-gradient(90deg, #0ba98d 0%, #0893b2 100%)', color: '#fff', fontWeight: 600, fontSize: 18, borderRadius: 999, py: 2, textTransform: 'none', boxShadow: 'none', '&:hover': { background: 'linear-gradient(90deg, #089e8e 0%, #0893b2 100%)', opacity: 0.95, boxShadow: 'none', }, mb: 1 }}>
                Proceed to Payment
              </Button>
