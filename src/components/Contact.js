            ...
            <Paper elevation={2} sx={{ p: { xs: 2, md: 4 }, borderRadius: 4, width: '100%', maxWidth: 480 }}>
              ...
              <Box component="form" noValidate autoComplete="off">
                ...
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 2, mb: 2 }}>
                  <TextField label="Full Name" required fullWidth variant="outlined" margin="dense" sx={{ flex: 1 }} />
                  <TextField label="Email Address" required fullWidth variant="outlined" margin="dense" type="email" sx={{ flex: 1 }} />
                </Box>
                {/* Subject full width */}
                <Box sx={{ mb: 2 }}>
                  <TextField label="Subject" required fullWidth variant="outlined" margin="dense" />
                </Box>
                {/* Message full width, larger height */}
                <Box sx={{ mb: 2 }}>
                  <TextField label="Message" required fullWidth variant="outlined" margin="dense" multiline rows={6} />
                </Box>
                <Button variant="contained" endIcon={<SendIcon />} sx={{ borderRadius: 999, px: 4, py: 1.2, fontWeight: 700, fontSize: 16, background: gradient, color: '#fff', boxShadow: 'none', '&:hover': { background: '#067e71' }, width: '100%' }}>
                  Send Message
                </Button>
              </Box>
            </Paper>
